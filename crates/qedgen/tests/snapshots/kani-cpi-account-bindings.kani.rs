// ---- GENERATED BY QEDGEN ---- spec-hash:e8be2de45d9db0db
//
...
#[derive(Clone, Copy)]
struct LoyalSwapLargeGuardAccounts {
    admin: KaniAccount,
    pool_ta: KaniAccount,
    user_ta: KaniAccount,
    token_program: KaniAccount,
...
fn loyal_swap_large_guard(s: &mut State, accounts: &LoyalSwapLargeGuardAccounts, amount_in: u128, min_out: u128, fee_bps: u128, lane: u8, input_mint: [u8; 32], output_mint: [u8; 32]) -> bool {
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_1_pubkey_eq_accounts_admin_pubkey_s_admin_key() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
    ...
    let accounts = LoyalSwapLargeGuardAccounts {
        admin: KaniAccount { pubkey: kani::any() },
        pool_ta: KaniAccount { pubkey: kani::any() },
        user_ta: KaniAccount { pubkey: kani::any() },
        token_program: KaniAccount { pubkey: kani::any() },
    ...
    assert!(!(pubkey_eq(&accounts.admin.pubkey, &s.admin_key)),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_2_amount_in_0() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_3_min_out_0() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_4_fee_bps_10000() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_5_lane_32() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_6_pubkey_ne_input_mint_output_mint() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
    ...
    assert!(!(pubkey_ne(&input_mint, &output_mint)),
        "loyal_swap_large_guard guard term must be false when violated");
}
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_7_pubkey_eq_input_mint_output_mint_amount_in_min_out() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
    ...
    assert!(!(((pubkey_eq(&input_mint, &output_mint)) || (amount_in >= min_out))),
        "loyal_swap_large_guard guard term must be false when violated");
}
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_8_mul_bps_floor_u128_amount_in_fee_bps_amount_in() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_9_amount_in_min_out() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_rejects_invalid_10_amount_in_1000000000000000() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
    ...
    assert!(!(amount_in <= 1000000000000000),
        "loyal_swap_large_guard guard term must be false when violated");
}
...
#[kani::unwind(2)]
#[kani::solver(cadical)]
fn verify_loyal_swap_large_guard_ensures_0() {
    let mut s = State {
        admin_key: kani::any(),
        pool_balance: kani::any(),
        user_balance: kani::any(),
    ...
    let pre = s.clone();
    if loyal_swap_large_guard(&mut s, &accounts, amount_in, min_out, fee_bps, lane, input_mint, output_mint) {
        let post = &s;
        assert!(post.pool_balance == pre.pool_balance,
            "ensures clause 0 on loyal_swap_large_guard violated by spec-translated transition");
    }
}
